...
class Turbina ( Frame ):
	...
	def __init__(self,configs,modbus_addrs,parent, controller):
		...
		uvazaocomb = Label(self.fdados,text='L/h',font=("Arial", 13),padding=(0,0,0,20))
		uvazaocomb.grid(row=0,column=3,sticky='w')
		uvazaoar = Label(self.fdados,text='L/h',font=("Arial", 13),padding=(0,0,0,20))
		...
		self.avazao.set_ylabel("Vazão [L/h]")
	...
	def updateTurb(self,dados):
		...
		self.vazaocomb.grid(row=0,column=2,padx=30,sticky='we')
